...
\begin{document}
    ...
    \section{Main Report}
        ...
        \subsection{Deleting blocks}
            A big objective for the user is the ability to edit their programs. This includes
            ...
            delete a block as this would also clear all their progress.
        ...
        \subsection{Maintaining order of the program}
            ...
            Below in Figures 14-17, we can see how the methods I have discussed work in practice. The console
            in Figure 14 console reveals to us the block structure working as intended, sorting by their Y
            coordinate. \\
            ...
            In Figure 15, I reajust the program, moving one block further to the right but above the
            ...
            Figure 16 proves how when aligning all of the blocks by their Y coordinates, that their X
            ...
            Furthermore in Figure 17, continuing from Figure 16, if I were to move just a few of the
            ...
            \begin{figure}[h]
                ...
                \caption{In relation to Figure 16, if we adjust their Y coordinate, it will update
                its block structure.}
            \end{figure}
